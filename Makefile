...
deploy-exporter: package-exporter
	...
	aws cloudformation deploy --template-file $(EXPORTER_GENERATED_TEMPLATE_ABSOLUTE_PATH) --stack-name $(EXPORTER_STACK_NAME) --capabilities CAPABILITY_IAM --parameter-overrides SentryEnvironment=$(SENTRY_ENV)
